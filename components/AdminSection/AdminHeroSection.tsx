    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 py-24 sm:py-32">
        ...
        >
          ...
          >
            Empower government officials and tourist spot owners with AI
            analytics to enhance visitor experiences and boost tourism economy.
          </motion.p>
