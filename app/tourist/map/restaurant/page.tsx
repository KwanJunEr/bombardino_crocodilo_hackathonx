  ...
  const reviews = [
    {
      ...
      rating: 5,
      comment: "Amazing ikan curry! They cooked my patin perfectly. The spices were incredible.",
    ...
    },
    {
      ...
      avatar: "/placeholder.svg?height=40&width=40",
      rating: 4,
      comment: "Great service and the curry was delicious. Will definitely bring my catch here again!",
    ...
    },
    {
      ...
      avatar: "/placeholder.svg?height=40&width=40",
      rating: 5,
      comment: "Best place to cook your fresh catch. The ikan curry is a must-try!",
      platform: "Yelp",
      date: "2 weeks ago",
    },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-orange-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Let Restaurants Cook Your Hard-Earned Caught Fish</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Bring your fresh catch and let our expert chefs transform it into a culinary masterpiece. We specialize in
            traditional and modern fish preparations.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">🐟 Recent Caught Fish</CardTitle>
                <CardDescription>Select the fish you'd like us to prepare</CardDescription>
              </CardHeader>
              <CardContent>
                ...
                {selectedFish && (
                  <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                    <p className="text-sm font-medium text-blue-900">Great choice!</p>
                    <p className="text-sm text-blue-700 mt-1">
                      ...
                      {selectedFish === "ikan-kembung" && "Indian Mackerel is excellent for traditional curry recipes."}
                      {selectedFish === "ikan-siakap" && "Sea Bass has a delicate flavor perfect for aromatic curries."}
                      {selectedFish === "ikan-merah" &&
                        "Red Snapper creates an exceptional curry with its firm texture."}
                      {selectedFish === "ikan-bawal" && "Pomfret is ideal for rich, coconut-based curry preparations."}
                    </p>
                  </div>
                )}
              </CardContent>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    <CardTitle className="text-2xl">🍛 Chef's Special: Ikan Curry</CardTitle>
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 mb-4">
                      Our signature ikan curry features your fresh catch simmered in a rich, aromatic blend of coconut
                      milk, lemongrass, galangal, and traditional spices. The curry is slow-cooked to perfection,
                      allowing the fish to absorb all the complex flavors while maintaining its tender texture.
                    </p>
                    ...
                    <div className="text-2xl font-bold text-green-600 mb-4">
                      $28.00
                      <span className="text-sm font-normal text-gray-600 ml-2">(cooking fee + ingredients)</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 text-center">
                  ...
                  <p className="text-sm text-gray-600 mt-2">Reserve your table and bring your fresh catch!</p>
                </div>
              </CardContent>
            </Card>
          </div>
