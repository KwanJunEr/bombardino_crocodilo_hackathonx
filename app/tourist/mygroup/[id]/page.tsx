      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center">
        <div className="text-center p-8 bg-white rounded-xl shadow-lg">
          ...
          <p className="text-gray-600">
            The fishing group you&apos;re looking for doesn&apos;t exist.
          </p>
        </div>
      </div>
    );
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg">
                Connect, Compete, and Catch Together
              </p>
            </div>
          </div>
              ...
              >
                ...
                <div className="relative z-10 p-8 h-full flex flex-col justify-between">
                  ...
                  <div className="flex gap-3">
                    <Link
                      href={`/tourist/mygroup/${groupID}/${groupData.challenge.id}`}
                    >
                      <Button className="bg-white/90 text-orange-700 hover:bg-white hover:text-orange-800 font-semibold px-6 py-3 backdrop-blur-sm border border-white/30 transition-all duration-300 group-hover:scale-105">
