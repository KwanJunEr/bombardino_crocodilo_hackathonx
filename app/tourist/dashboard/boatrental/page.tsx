...
const boats: Boat[] = [
  ...
  },
  {
    ...
    description:
      "Perfect family fishing boat for beginners and casual fishing. Safe and comfortable for all ages.",
    specifications: {
      length: "22 ft",
      engine: "Single 115HP",
      fuel: "Petrol",
  ...
  },
  {
    ...
    description:
      "Traditional Malaysian fishing boat experience with local fishing techniques and cultural immersion.",
    specifications: {
      length: "28 ft",
      engine: "Single 140HP",
      fuel: "Diesel",
...
export default function BoatRental() {
  ...
  if (currentView === "summary") {
    return (
      <TravelSummary rentalDetails={rentalDetails} onBack={handleBackToGrid} />
    );
  }
      ...
      <div className="max-w-7xl mx-auto ">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Find the perfect fishing boat for your angling adventure
          </p>
        </div>
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <div className="text-2xl font-bold">
                      RM{boat.pricePerHour}
                    </div>
                    <div className="text-sm text-gray-500">per hour</div>
                  </div>
                  <Button onClick={() => handleBoatSelect(boat)}>
                    View Details
                  </Button>
                </div>
              </CardContent>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            ...
                            <span className="ml-2 font-medium">
                              {selectedBoat.specifications.length}
                            </span>
                          </div>
                          <div>
                            <span className="text-gray-500">Engine:</span>
                            <span className="ml-2 font-medium">
                              {selectedBoat.specifications.engine}
                            </span>
                          </div>
                          <div>
                            <span className="text-gray-500">Fuel:</span>
                            <span className="ml-2 font-medium">
                              {selectedBoat.specifications.fuel}
                            </span>
                          </div>
                          <div>
                            <span className="text-gray-500">Max Speed:</span>
                            <span className="ml-2 font-medium">
                              {selectedBoat.specifications.speed}
                            </span>
                          </div>
                        </div>
                      </div>
                        ...
                        <Select value={duration} onValueChange={setDuration}>
                          ...
                          <SelectContent>
                            <SelectItem value="2-hours">
                              2 Hours - RM{selectedBoat.pricePerHour * 2}
                            </SelectItem>
                            <SelectItem value="4-hours">
                              4 Hours - RM{selectedBoat.pricePerHour * 4}
                            </SelectItem>
                            <SelectItem value="6-hours">
                              6 Hours - RM{selectedBoat.pricePerHour * 6}
                            </SelectItem>
                            <SelectItem value="8-hours">
                              8 Hours - RM{selectedBoat.pricePerHour * 8}
                            </SelectItem>
                            <SelectItem value="full-day">
                              Full Day - RM{selectedBoat.pricePerDay}
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                        ...
                        <div className="flex justify-between font-semibold text-lg">
                          ...
                          <span>
                            ...
                            {(duration === "full-day"
                              ? selectedBoat.pricePerDay
                              : selectedBoat.pricePerHour *
                                Number.parseInt(duration.split("-")[0])) + 20}
                          </span>
                        </div>
                      </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Your boat rental has been successfully booked
              </p>
            </div>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-1">
                    <Users className="w-4 h-4 text-gray-500" />
                    <span className="text-sm">
                      Up to {rentalDetails.boat.capacity} guests
                    </span>
                  </div>
                  <div className="flex items-center gap-1">
                    <Star className="w-4 h-4 fill-yellow-400 text-yellow-400" />
                    <span className="text-sm font-medium">
                      {rentalDetails.boat.rating}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        {rentalDetails.duration.replace("-", " ")}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        {rentalDetails.guests}{" "}
                        {rentalDetails.guests === 1 ? "person" : "people"}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-blue-700">
                    Your booking is protected with free cancellation up to 24
