...
const fishingActivities = [
  {
    id: 1,
    title: "Pahang River Fishing Competition",
    location: "Pahang River, Pekan",
    difficulty: "Beginner",
    duration: "4-6 hours",
    bestTime: "Early Morning",
    fishTypes: ["Kelah", "Lampam", "Baung"],
    image: "/comp1.jpg?height=200&width=300",
    rating: 4.5,
  },
  {
    id: 2,
    title: "Kuala Pahang Estuary Fishing Competition",
    location: "Kuala Pahang, Pekan",
    difficulty: "Intermediate",
    duration: "6-8 hours",
    bestTime: "Dawn & Dusk",
    fishTypes: ["Siakap", "Jenahak", "Kerapu"],
    image: "/comp2.jpg?height=200&width=300",
    rating: 4.8,
  },
  {
    id: 3,
    ...
    image: "/comp4.jpg?height=200&width=300",
    rating: 4.7,
  },
  {
    id: 4,
    title: "Pekan Jetty Night Fishing Competition",
    location: "Pekan Jetty",
    difficulty: "Beginner",
    duration: "4-5 hours",
    bestTime: "Night",
    fishTypes: ["Kembung", "Selar", "Tamban"],
    image: "/comp3.jpg?height=200&width=300",
    rating: 4.3,
  },
];
...
export default function FishingDashboard() {
  ...
  const prevActivity = () => {
    setCurrentActivityIndex(
      (prev) =>
        (prev - 1 + fishingActivities.length) % fishingActivities.length,
    );
  };
              ...
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 rounded-lg border-l-4 border-blue-500">
                  ...
                  <p className="text-sm text-blue-700">
                    Based on weather patterns and tidal data, tomorrow morning
                    (6-9 AM) shows optimal conditions for fishing at Kuala
                    Pahang Estuary.
                  </p>
                </div>
                ...
                <div className="p-4 bg-green-50 rounded-lg border-l-4 border-green-500">
                  ...
                  <p className="text-sm text-green-700">
                    High probability of Siakap and Jenahak activity near river
                    mouths due to incoming tide and moderate cloud cover.
                  </p>
                </div>
                ...
                <div className="p-4 bg-orange-50 rounded-lg border-l-4 border-orange-500">
                  ...
                  <p className="text-sm text-orange-700">
                    Consider exploring the northern section of Pahang River -
                    recent reports show increased fish activity in that area.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold">
                      From 27th May 2025 to 30th May 2025 is a great time for
                      Fishing in Pekan, Pahang
                    </h3>
                ...
                <Link href={"/tourist/dashboard/setup"}>
                  <Button>Start My Fishing Journey</Button>
                </Link>
              </div>
            </CardContent>
          </Card>
